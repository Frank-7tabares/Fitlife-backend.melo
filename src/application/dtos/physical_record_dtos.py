...
class PhysicalRecordRequest(BaseModel):
    ...
    body_fat_percentage: Optional[float] = Field(None, ge=2.0, le=70.0, description='% grasa corporal (2–70)')
    ...
    recorded_at: Optional[datetime] = Field(default=None, description='Marca de tiempo del registro (ISO 8601). Si no se proporciona, se usa la fecha/hora actual.')
