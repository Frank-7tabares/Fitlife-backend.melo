"""
Middleware CORS que inyecta los headers en todas las respuestas y responde al preflight OPTIONS.
Permite frontend Vite (5173, 5174) y Angular (4200).
"""
import os
...
CORS_ORIGINS = tuple(_cors_list) if _cors_list else (
    "http://localhost:5173",
    "http://localhost:5174",
    "http://localhost:4200",
    "http://127.0.0.1:5173",
