...
async def test_smtp(email: str=''):
    ...
    try:
        ...
        sent = await SmtpEmailService.send_password_reset_email(to_email=email, reset_token='test-token', user_name='Test')
...
async def register(request: RegisterUserRequest, user_repo: SQLAlchemyUserRepository=Depends(get_user_repository), refresh_repo: SQLAlchemyRefreshTokenRepository=Depends(get_refresh_token_repository), instructor_repo: SQLAlchemyInstructorRepository=Depends(get_instructor_repository)):
...
async def login(request: LoginUserRequest, user_repo: SQLAlchemyUserRepository=Depends(get_user_repository), refresh_repo: SQLAlchemyRefreshTokenRepository=Depends(get_refresh_token_repository)):
...
async def refresh(request: RefreshTokenRequest, user_repo: SQLAlchemyUserRepository=Depends(get_user_repository), refresh_repo: SQLAlchemyRefreshTokenRepository=Depends(get_refresh_token_repository)):
...
async def reset_password(request: PasswordResetDto, user_repo: SQLAlchemyUserRepository=Depends(get_user_repository), reset_token_repo: SQLAlchemyPasswordResetTokenRepository=Depends(get_password_reset_token_repository), password_history_repo: SQLAlchemyPasswordHistoryRepository=Depends(get_password_history_repository)):
...
async def change_password(user_id: UUID, request: PasswordChangeDto, user_repo: SQLAlchemyUserRepository=Depends(get_user_repository), password_history_repo: SQLAlchemyPasswordHistoryRepository=Depends(get_password_history_repository), refresh_repo: SQLAlchemyRefreshTokenRepository=Depends(get_refresh_token_repository)):
