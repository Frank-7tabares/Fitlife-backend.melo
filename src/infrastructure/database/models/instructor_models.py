"""Modelos SQLAlchemy para instructores, asignaciones y calificaciones (Historia 3)."""
...
class InstructorModel(Base):
    ...
    certifications = Column(JSON, nullable=False)  # list of strings
    specializations = Column(String(500), nullable=True)
    rating_avg = Column(Float, default=0.0, nullable=False)
    certificate_url = Column(String(500), nullable=True)  # URL del certificado profesional
