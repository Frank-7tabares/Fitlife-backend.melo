"""Servicio de dominio: Validación de complejidad de contraseña."""
import re
...
class PasswordValidator:
    ...
    def validate(password: str) -> Tuple[bool, str]:
        """Valida contraseña y devuelve (es_válida, mensaje_error)."""
    ...
    def validate_or_raise(password: str) -> None:
        """Valida contraseña y lanza WeakPasswordException si no cumple requisitos."""
