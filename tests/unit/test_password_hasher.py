"""
Pruebas unitarias — PasswordHasher
Casos borde sobre hashing y verificación de contraseñas.
"""
import pytest
...
class TestPasswordHasher:
    ...
    def test_same_password_produces_different_hashes(self):
        # bcrypt usa salt aleatorio → dos hashes distintos del mismo password
        plain = "MiPassword123!"
    ...
    def test_very_long_password(self):
        # bcrypt trunca en 72 bytes — verificamos que funciona igual
        long_password = "A" * 72
